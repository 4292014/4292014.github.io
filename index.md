...
简介
-------
<font size="4">RGB相机实时高精度人嘴唇三维重建</font>
-------
...
>3. 快手提供了3d人脸形变模型、人脸特征点检测和基于神经网络的人脸重建方法；用2中精细唇线改善快手重建效果，得嘴唇高精度重建结果。即在精细唇线上找三维嘴唇顶点的对应点，优化求解人脸形变模型的线性组合系数。  
...
**相关工作**：<br/>
>1. 眼镜相关的工作不多；主要有 1>从人脸图像中去除眼镜 2>检测人脸图像中是否有眼镜。有论文[3]从图像序列中恢复人脸深度，并重建眼镜。没有只输入单张图像重建三维眼镜的工作。</br>
>2. 拉普拉斯形变：拉普拉斯算子能提取三维网格的局部特征；保证网格的拉普拉斯坐标不变，网格顶点位置变化，能达到保留局部形状特征的变形效果。[4]<br/> 
...
**方法**：图像检测镜框；以二维像素驱动三维眼镜模板拉普拉斯形变，使三维眼镜尽可能与二维图像相同<br/>
程序运行顺序如下：  
...
**关键算法**：  
>1. 二维像素驱动的三维眼镜拉普拉斯形变(已完成)
>2. 非线性优化计算人脸姿态(已完成)，基于透视投影模型，EPNP和LM优化方法。由EPNP得姿态初始值，再用LM非线性优化法优化
>3. 语义边缘检测神经网络的训练、数据增强
>4. 方法中23所描述的迭代找对应点和优化求解眼镜姿态的过程   
